...
%{
  ...
  #define seal_yylloc curr_lineno  /* use the curr_lineno from the lexer for the location of tokens */
    ...
    */
    ...
    %type <actuals> non_empty_actuals
    %type <actual> actual
    %type <variables> variable_list
    %type <stmt> stmt
    %type <expr> expr_
    %type <variables> non_empty_variable_list
	// Add more here
...
%%
    ...
    | variableDecl_list variableDecl {//no comma
    ...
    variable_list:  non_empty_variable_list    {
      $$ = $1; 
    }
    | {
      $$ = nil_Variables();
    ...
    non_empty_variable_list: variable {
      $$ = single_Variables($1);
    }
    | non_empty_variable_list ',' variable  {
    ...
    stmtBlock : '{' variableDecl_list stmts '}' {
      $$ = stmtBlock($2,$3);
    }
    ;
